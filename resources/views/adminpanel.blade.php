            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="bg-white border-b border-gray-200">
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link text-sm font-medium text-gray-900" id=""
                                data-bs-toggle="tab" data-bs-target="#approvals" type="button" role="tab"
                                aria-controls="approvals" aria-selected="false">Pending Approvals</button>
                        </li>
                    </ul>
                    <!-- Tas container -->
                    <div class="tab-content" id="myTabContent">
                                            ...
                                            <table class="min-w-full divide-y divide-gray-200"
                                                ...
                                                <tbody class="bg-white divide-y divide-gray-200"
                                                    ...
                                                    <tr id="busi{{ $business->id }}">
                                                        ...
                                                        <td class="px-2 py-2 whitespace-nowrap">
                                                            <span
                                                                class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full @if($business->activation_status == 1) bg-green-100 text-green-800 @else bg-red-100 text-red-800 @endif">
                                                        ...
                                                        <td
                                                            ...
                                                            <a href="adminpanel/activateBusiness/{{$business->id}}"
                                                                class="activateBusinessBtn inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
                                                                id="{{$business->id}}"
                                                                onclick="activateBusiness({{$business->id}});">Activate</a>
                                                                

                                                            @else

                                                            <a href="/viewBusiness/{{ $business->id }}"
                                                                class="viewBusinessBtn inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                                                                id="{{$business->id}}"
                                                                onclick="viewBusiness({{$business->id}});">View</a>

                                                            <a href="adminpanel/deactivateBusiness/{{$business->id}}"
                                                                class="deactivateBusinessBtn inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-yellow-600 hover:bg-yellow-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500"
                                                                id="{{$business->id}}"
                                                                onclick="deactivateBusiness({{$business->id}});">Deactivate</a>
                                                            @endif
                                           
                                                            <a href="adminpanel/deleteBusiness/{{$business->id}}"
                                                                class="deleteBusinessBtn inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
                                                                id="{{$business->id}}"
                                                                onclick="deleteBusiness({{$business->id}});">Delete</a>
                                                        </td>
                                                    </tr>
                                                    @endforeach
                                                ...
                                                <table class="min-w-full divide-y divide-gray-200">
                                                    <thead class="bg-gray-50">
                                                        <tr>
                                                            ...
                                                            <th
                                                                class="px-6 py-3 text-left text-xs font-medium text-gray-500 tracking-wider text-right">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-3">
                                        <ul class="nav nav-pills sidepills">
                                            ...
                                            @endphp
                                            <li class="nav-item">
                                                <a class="nav-link text-sm font-medium text-gray-900" id="@php echo $name @endphp-tab"
                                                    data-bs-toggle="tab" data-bs-target="#@php echo $name @endphp"
                                                    type="button" role="tab" aria-controls="@php echo $name @endphp"
                                                    aria-selected="false">
                                    ...
                                    <div class="col-sm-12 col-md-9">
                                        <div class="tab-content">
                                            ...
                                            $tablename = $name = str_replace(' ', '_', strtolower($industry->industry));
                                            @endphp
                                            <div class="tab-pane fade" id="@php echo $name; @endphp" role="tabpanel"
                                                aria-labelledby="contact-tab">
                                                <!-- This example requires Tailwind CSS v2.0+ -->
                                                <form class="ajax" id="servicesForm" data-target="insertService" id="insertService"
                                                    action="/admin/adminpanel/insertService" method="post">
                                                    @csrf
                                                    <span id="result"></span>

                                                    <input type="hidden" name="id" class="serviceId"
                                                        value="{{$industry->id}}">
                                                    <div class="flex flex-col">
                                                        <div class="my-2 pb-5 overflow-x-auto sm:-mx-6 lg:-mx-8">
                                                            <div
                                                                    ...
                                                                    <table class="min-w-full divide-y divide-gray-200">
                                                                        <thead class="bg-gray-50">
                                                                            <tr>
                                                                                ...
                                                                                <th scope="col"
                                                                                    class="px-2 py-2 whitespace-nowrap text-right text-sm font-medium">
                                                                                    <div class="addRowServices inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                                                                                        data-target="@php echo $tablename; @endphpTable">
                                                                                        Add</div>
                                                                                </th>
                                                                        ...
                                                                        <tbody class="bg-white divide-y divide-gray-200"
                                                                            id="@php echo $tablename; @endphpTable">
                                                                            @if($adminservices ?? '') @for($i=0; $i
                                                                            < count($adminservices); $i++)
                                                                                @if($adminservices[$i]->industryId ===
                                                                                $industry->id)
                                                                                <tr id="serv{{$adminservices[$i]->id}}">
                                                                                    <td colspan="2"
                                                                                        ...
                                                                                        <input disabled type="text"
                                                                                            name="name_service"
                                                                                            value="@php echo $adminservices[$i]->service_name; @endphp "
                                                                                            autocomplete="given-name"
                                                                                            class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                                                    </td>
                                                                                    <td class="px-2 py-2 whitespace-nowrap text-right text-sm font-medium"
                                                                                        data-target="@php echo $tablename; @endphp">
                                                                                        <a href="/admin/adminpanel/destroy/{{$adminservices[$i]->id}}"
                                                                                            class="deleteBtn inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
                                                                                            id="{{$adminservices[$i]->id}}"
                                                                                            onclick="deleteService({{$adminservices[$i]->id}});">Delete</a>
                                                                                    </td>
                                                                                </tr>
                                                                                @endif @endfor @endif
                                                ...
                                                <table class="min-w-full divide-y divide-gray-200">
                                                    <thead class="bg-gray-50">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th
                                                                class="px-6 py-3 text-left text-xs font-medium text-gray-500 tracking-wider text-right">
                                                                <div class="addRowProvince inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                                                                    data-target="provinceTable">Add</div>
                                                            </th>
                                                        </tr>
                                                    </thead>
                                                    <tbody class="bg-white divide-y divide-gray-200" id="provinceTable">
                                                        ...
                                                        <tr id="prov{{$province->id}}">
                                                            ...
                                                            <td class="px-2 py-2 whitespace-nowrap text-right text-sm font-medium"
                                                                data-target="provinceTable">
                                                                <a href="/adminpanel/deleteProvince/{{$province->id}}"
                                                                    onclick="deleteProvince({{$province->id}})"
                                                                    class="deleteProvinceBtn inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
                                                                    id="{{$province->id}}">Delete</a>
                                                            </td>
                                                        </tr>
                                    ...
                                    <div class="col-sm-12 col-md-9">
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane fade" id="@php echo $name; @endphp" role="tabpanel"
                                                aria-labelledby="contact-tab">
                                                <!-- This example requires Tailwind CSS v2.0+ -->
                                                <form class="ajax" data-target="insertDistrict" id="insertDistrict" action="/admin/adminpanel/insertDistrict"
                                                    method="post">
                                                    @csrf
                                                                    ...
                                                                    <table class="min-w-full divide-y divide-gray-200">
                                                                        <thead class="bg-gray-50">
                                                                            <tr>
                                                                                ...
                                                                                <th scope="col"
                                                                                    class="px-2 py-2 whitespace-nowrap text-right text-sm font-medium">
                                                                                    <div class="addRowDistricts inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                                                                                        data-target="@php echo $tablename; @endphpTable">
                                                                                        Add</div>
                                                                                </th>
                                                                        ...
                                                                        <tbody class="bg-white divide-y divide-gray-200"
                                                                            ...
                                                                            < count($admindistricts); $i++)
                                                                                @if($admindistricts[$i]->provinceId ===
                                                                                $province->id)
                                                                                <tr
                                                                                    id="dist{{$admindistricts[$i]->id}}">
                                                                                    <td colspan="2"
                                                                                        class="px-6 py-2 whitespace-nowrap">
                                                                                        <input disabled type="text"
                                                                                            name="name_service"
                                                                                            value="@php echo $admindistricts[$i]->municipal_district; @endphp "
                                                                                            autocomplete="given-name"
                                                                                            class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                                                    </td>
                                                                                    <td class="px-2 py-2 whitespace-nowrap text-right text-sm font-medium"
                                                                                        data-target="@php echo $tablename; @endphp">
                                                                                        <a href="/admin/adminpanel/deleteMuni/destroy/{{$admindistricts[$i]->id}}"
                                                                                            class="deleteBtn inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
                                                                                            id="{{$admindistricts[$i]->id}}"
                                                                                            onclick="deleteMunicipality({{$admindistricts[$i]->id}});">Delete</a>
                                                                                    </td>
                                                                                </tr>
                                                                                @endif @endfor @endif
                        ...
                        <div class="tab-pane fade " id="municipalities" role="tabpanel" aria-labelledby="contact-tab">
                            <div class="container-fluid mt-5">
                                <div class="row">
                                    <div class="col-sm-12 col-md-3">
                                            ...
                                            <div class="accordion-item">
                                                ...
                                                <h2 class="accordion-header" id="flush-headingOne">
                                                    <button class="accordion-button collapsed" type="button"
                                                        ...
                                                        data-bs-target="#flush-collapse@php echo $accordName; @endphp"
                                                        aria-expanded="false"
                                                        aria-controls="flush-collapse@php echo $accordName; @endphp">
                                                        <p class="text-sm font-medium text-gray-900">{{ $prov->province }}</p>
                                                    </button>
                                                </h2>

                                                <div id="flush-collapse@php echo $accordName; @endphp"
                                                    class="accordion-collapse collapse"
                                                    aria-labelledby="flush-headingOne"
                                                    data-bs-parent="#accordionProvinces">
                                                    <div class="accordion-body">
                                                        ...
                                                        <ul class="nav nav-pills sidepills">
                                                            ...
                                                            @endphp
                                                            <li class="nav-item">
                                                                <a class="nav-link" id="@php echo $name @endphp-tab"
                                                                    data-bs-toggle="tab"
                                                                    data-bs-target="#@php echo $name @endphp"
                                                                    type="button" role="tab"
                                                                    aria-controls="@php echo $name @endphp"
                                                                    aria-selected="false">
                                    ...
                                    <div class="col-sm-12 col-md-9">
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane fade" id="@php echo $name; @endphp" role="tabpanel"
                                                aria-labelledby="contact-tab">
                                                <!-- This example requires Tailwind CSS v2.0+ -->
                                                <form class="ajax" data-target="insertMunicipality" id="insertMunicipality" action="/admin/adminpanel/insertMunicipality"
                                                    method="post">
                                                    @csrf
                                                                    ...
                                                                    <table class="min-w-full divide-y divide-gray-200">
                                                                        <thead class="bg-gray-50">
                                                                            <tr>
                                                                                ...
                                                                                <th scope="col"
                                                                                    class="px-2 py-2 whitespace-nowrap text-right text-sm font-medium">
                                                                                    <div class="addRowMunicipality inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                                                                                        data-target="@php echo $tablename; @endphpTable">
                                                                                        Add</div>
                                                                                </th>
                                                                        ...
                                                                        <tbody class="bg-white divide-y divide-gray-200"
                                                                            ...
                                                                            $i
                                                                            < count($adminmunicipalities); $i++)
                                                                                @if($adminmunicipalities[$i]->
                                                                                districtId === $districts->id)
                                                                                <tr
                                                                                    id="muni{{$adminmunicipalities[$i]->id}}">
                                                                                    <td colspan="2"
                                                                                        class="px-6 py-2 whitespace-nowrap">
                                                                                        <input disabled type="text"
                                                                                            name="name_service"
                                                                                            value="@php echo $adminmunicipalities[$i]->municipality; @endphp "
                                                                                            autocomplete="given-name"
                                                                                            class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                                                    </td>
                                                                                    <td class="px-2 py-2 whitespace-nowrap text-right text-sm font-medium"
                                                                                        data-target="@php echo $tablename; @endphp">
                                                                                        <a href="/admin/adminpanel/deleteMuni/destroy/{{$adminmunicipalities[$i]->id}}"
                                                                                            class="deleteBtn inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
                                                                                            id="{{$adminmunicipalities[$i]->id}}"
                                                                                            onclick="deleteMunicipality({{$adminmunicipalities[$i]->id}});">Delete</a>
                                                                                    </td>
                                                                                </tr>
                                                                                @endif @endfor @endif
                                            ...
                                            <table class="min-w-full divide-y divide-gray-200"
                                                ...
                                                <tbody class="bg-white divide-y divide-gray-200"
                                                    ...
                                                    <tr id="busi{{ $business->id }}">
                                                        ...
                                                        <td class="px-2 py-2 whitespace-nowrap text-right text-sm font-medium">
                                                            @if($item->status == 0)
                                                                <a href="adminpanel/approveItem/{{$item->id}}"
                                                                    class="approveItemBtn inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
                                                                    id="{{$item->id}}"
                                                                    onclick="approveItem({{$item->id}});">Approve</a>
                                                            @else
                                                                <a href="adminpanel/declineItem/{{$item->id}}"
                                                                    class="declineItemBtn inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
                                                                    id="{{$item->id}}"
                                                                    onclick="declineItem({{$item->id}});">Decline</a>
                                                            @endif
                                                        </td>
