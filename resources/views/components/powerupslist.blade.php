<div class="bg-white overflow-hidden shadow-sm sm:rounded-lg my-4">
    <div class="p-6 bg-white border-b border-gray-200">
        <div class="grid sm:grid-flow-row md:grid-cols-9 gap-4">
            <!-- Website -->
            <a href="{{ route('bdashboard.website') }}">
                <div class="flex flex-col items-center text-center justify-center">
                    ...
                    <p class="mt-2 text-xs">Website</p>
                </div>
            </a>
            <!-- Accounting Services -->
            <a href="{{ route('bdashboard.accounting') }}">
                <div class="flex flex-col items-center text-center justify-center">
                    ...
                    <p class="mt-2 text-xs">Accounting Services</p>
                </div>
            </a>
            <!-- Tax Returns -->
            <a href="{{ route('bdashboard.tax') }}">
                ...
                <div class="flex flex-col items-center text-center justify-center">
                    ...
                    <p class="mt-2 text-xs">Tax Returns</p>
                </div>
            </a>
            <!-- Business Plan -->
            <a href="{{ route('bdashboard.businessplan') }}">
                ...
                <div class="flex flex-col items-center text-center justify-center">
                    ...
                    <p class="mt-2 text-xs">Business Plan</p>
                </div>
            </a>
            ...
            <a href="{{ route('bdashboard.companyregistration') }}">
                ...
                <div class="flex flex-col items-center text-center justify-center">
                    ...
                    <p class="mt-2 text-xs">Company Registration</p>
                </div>
            </a>
            <!-- Marketplace -->
            <a href="{{ route('bdashboard.accounting') }}">
                ...
                <div class="flex flex-col items-center text-center justify-center">
                    ...
                    <p class="mt-2 text-xs">Marketplace</p>
                </div>
            </a>
            <!-- Quotes -->
            <a href="{{ route('bdashboard.accounting') }}">
            ...
            <a href="{{ route('bdashboard.accounting') }}">
                ...
                <div class="flex flex-col items-center text-center justify-center">
                    ...
                    <p class="mt-2 text-xs">Invoices</p>
                </div>
            </a>
            <!-- Transaction History -->
            <a href="{{ route('bdashboard.accounting') }}">
                ...
                <div class="flex flex-col items-center text-center justify-center">
                    ...
                    <p class="mt-2 text-xs">Transaction History</p>
                </div>
            </a>
        </div>
    </div>
