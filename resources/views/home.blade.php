<x-app-layout title="Home">
    ...
    <div class="p-6 ml-16 md:px-10">
        <div class="flex items-center border rounded-lg">
            <div class="relative-16">
                <form class="flex" action="/search" id="header_find_form" role="search" method="get"
                    ...
                    <div class="flex items-center">
                        <div class="relative">
                            <label class="text-gray-600 font-semibold" for="search_description">
                                <div
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                        ...
                                        <line x1="60" y1="60" x2="90" y2="90" stroke="black"
                                            stroke-width="2" />
                                    </svg>

                                </div>
                                <input aria-label="Find" autocomplete="off" role="textbox" aria-autocomplete="list"
                                    tabindex="0" name="find_desc" data-testid="suggest-desc-input"
                            ...
                            <div id="dropdown"
                                ...
                                <div class="dropdown-item px-3 py-2 cursor-pointer hover:bg-gray-100">Hair and beauty
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <label class="text-gray-700 font-semibold" for="search_location">
                    <span class="inline-block w-6 h-6">
                        <svg width="30px" height="30px" viewBox="0 0 100 150" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" fill="#FF5733" class="mr-2 mt-2">
                    ...
                    <select aria-label="Near" autocomplete="off" role="textbox" aria-autocomplete="list" tabindex="0"
                        data-testid="suggest-location-input" id="search_location"
