            ...
            <form id="searchForm" class="col-md-4">
                <div class="container bg-white shadow-sm py-12 rounded-md">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <label for="provinceOptions" class="block text-sm font-medium text-gray-700">Province</label>
                        ...
                        <div class="col-12">
                            <label for="districtOptions" class="block text-sm font-medium text-gray-700">District</label>
                        ...
                        <div class="col-12">
                            <label for="municipalityOptions" class="block text-sm font-medium text-gray-700">Municipality</label>
                        ...
                        <div class="col-12">
                            <label for="industryOptions" class="block text-sm font-medium text-gray-700">Industry</label>
