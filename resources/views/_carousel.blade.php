                            ...
                            <div class="relative">
                                <label class="text-gray-700 font-semibold relative" for="search_location">
                                    <span class="inline-block w-6 h-6 absolute top-2 left-0">
                                        <svg width="30px" height="30px" viewBox="0 0 100 150"
                                    ...
                                    <select aria-label="Near" autocomplete="off" role="textbox" aria-autocomplete="list"
                                        tabindex="0" data-testid="suggest-location-input" id="provinceOptions"
                                ...
                                <button aria-label="Search" type="submit"
                                    ...
                                    data-activated="false" data-testid="suggest-submit" value="submit"
                                    data-button="true">
                                    Search
                                </button>
                    </form>
