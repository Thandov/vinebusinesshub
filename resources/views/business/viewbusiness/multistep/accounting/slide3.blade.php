...
<div class="bg-white shadow rounded-lg p-6">
    ...
    <div class="mb-4">
        <label for="income_sources" class="block text-gray-700 font-semibold mb-2">Sources of Income</label>
        <textarea id="income_sources" name="income_sources" class="border border-gray-300 p-2 rounded-md w-full h-24"></textarea>
    </div>
