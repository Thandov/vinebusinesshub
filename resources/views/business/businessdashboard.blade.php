                                            ...
                                            <div class="md:grid md:grid-cols-3 md:gap-6">
                                                <div class="md:col-span-6">
                                                    <div class="pr-4 sm:px-0">
                                                        ...
                                                        <a onclick="deleteBusinessandUser({{ $business[0]->id }});" href="deleteBusinessandUser/{{ $business[0]->id }}" class="mt-1 text-sm text-gray-600 inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">Delete
                                                            Profile
                                                        </a>
                                                    </div>
                                                </div>
