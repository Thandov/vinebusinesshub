                                ...
                                <dl>
                                    ...
                                    <dd>
                                        <div class="text-lg font-medium text-gray-900">
                                            <p class="mt-1 max-w-2xl text-sm text-gray-500">All the digital power in your hands</p>
                                        </div>
                                    </dd>
                                </dl>
                            </div>
                                ...
                                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                    <div class="md:grid md:grid-row md:gap-4">
                                        <div class="pr-4 sm:px-0">
                                            ...
                                            <p class="mt-1 text-sm text-gray-600">Manage your profile from this dashboard.</p>
